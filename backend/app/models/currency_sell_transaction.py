...
class CurrencySellTransaction(BaseModel):
    """Selling foreign currency TO customer (customer gives MMK, we give THB)."""

    __tablename__ = "currency_sell_transactions"
    ...
    customer = relationship(
        "Customer", back_populates="currency_sell_transactions", lazy="joined"
    )
    ...
    def __repr__(self) -> str:
        return f"<CurrencySellTransaction(number={self.transaction_number}, amount={self.foreign_amount} {self.currency_code})>"
